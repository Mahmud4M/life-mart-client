...
const Product = () => {
    ...
    return (
        <>
            ...
            <div className="sort flex justify-between items-center px-40 mt-10">
                ...
                <div>
                    <form onSubmit={handleSearch}>
                        <div className="search flex flex-col p-1.5 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
            ...
            <div className="card grid lg:grid-cols-4 md:2 sm:grid-cols-1 gap-4 items-center px-36 mt-5">
                {
            ...
            <div>
                <div className="flex items-center justify-center mx-auto mt-10">
                    <button
                        ...
                        className="button-prev px-4 py-2 mx-1 text-white transition-colors duration-300 transform bg-[#0f503c] rounded-md dark:bg-gray-800 dark:text-white hover:bg-yellow-600 hover:text-white dark:hover:text-gray-200">
...

                    {
                        pages.map(btnNum => <button
                            ...
                            key={btnNum}
                            href="#"
                            className={`${currentPage === btnNum ? 'bg-yellow-600 text-white' : ''} button px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-white rounded-md sm:inline dark:bg-gray-800 dark:text-gray-200 hover:bg-yellow-600 dark:hover:bg-yellow-600 hover:text-white dark:hover:text-gray-200`}>
                            {btnNum}
                        </button>)
                    }
                    ...
                    <button
                        ...
                        onClick={() => handlePaginationButton(currentPage + 1)}
                        className="button-next px-4 py-2 mx-1 text-white transition-colors duration-300 transform bg-[#0f503c] rounded-md dark:bg-gray-800 dark:text-white hover:bg-yellow-600 dark:hover:bg-yellow-600 hover:text-white dark:hover:text-gray-200">
                        <div className="flex items-center -mx-1">
                            <span className="mx-1">
                                Next
                            </span>
